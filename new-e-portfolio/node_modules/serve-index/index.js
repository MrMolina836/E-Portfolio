...
function createHtmlFileList(files, dir, useIcons, view) {
  var html = '<ul id="files" className="view-' + escapeHtml(view) + '">'
    + (view == 'details' ? (
      '<li className="header">'
  ...
  html += files.map(function (file) {
    ...
    return '<li><a href="'
      ...
      + '" className="' + escapeHtml(classes.join(' ')) + '"'
      + ' title="' + escapeHtml(file.name) + '">'
      + '<span className="name">' + escapeHtml(file.name) + '</span>'
      + '<span className="size">' + escapeHtml(size) + '</span>'
      + '<span className="date">' + escapeHtml(date) + '</span>'
      + '</a></li>';
  }).join('\n');
