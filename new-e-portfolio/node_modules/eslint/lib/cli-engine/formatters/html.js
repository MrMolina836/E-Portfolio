...
<html>
    ...
    <body>
        <div id="overview" className="bg-${reportColor}">
            <h1>ESLint Report</h1>
            <div>
...
function messageTemplate(it) {
    ...
    return `
<tr style="display: none;" className="f-${parentIndex}">
    <td>${lineNumber}:${columnNumber}</td>
    <td className="clr-${severityNumber}">${severityName}</td>
...
function resultTemplate(it) {
    ...
    return `
<tr className="bg-${color}" data-group="f-${index}">
    <th colspan="4">
        [+] ${encodeHTML(filePath)}
